...
function setupResizerEvents(objID) {
	var myFlex = document.getElementById(objID);
	myFlex.addEventListener("mousedown", function (md) {
		...
		if (target.nodeType !== 1 || target.className !== "flex-resizer") {
			return;
		}
...
setupResizerEvents("myFlex_0");
setupResizerEvents("myFlex_1");